...
def stopword_tokenization(text): #SCoRe Addition
    ...
    seperate_words = word_tokenize(text)  #Turns string in to array of strings
    return [w.lower() for w in seperate_words if not w in nltk_stop_words] #Matchs words in array to words in corpus and removes
